...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-th-list"></i>Manage Sales</h1>
                <!-- <p>Table to display analytical data effectively</p> -->
            </div>
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item">Sales</li>
                <li class="breadcrumb-item active"><a href="#">Manage Sales</a></li>
            </ul>
        </div>
        <div class="">
                             ...
                             @foreach($invoices as $invoice)
                                 <tr>
                                     ...
                                     <td>
                                         ...
                                         <button class="btn btn-success waves-effect" type="submit" onclick="approve({{ $invoice->id }})">
                                             <i class="fa fa-check"></i>
                                         </button>
                                         <button class="btn btn-danger waves-effect" type="submit" onclick="deleteTag({{ $invoice->id }})">
                                             <i class="fa fa-trash-o"></i>
                                         </button>
                                         <form id="approve-form-{{ $invoice->id }}" action="{{ route('approve',$invoice->id) }}" method="POST" style="display: none;">
                                             @csrf
                                             @method('PUT')
                                         </form>
