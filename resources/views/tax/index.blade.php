...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-th-list"></i> Commissions</h1>
                <!-- <p>Table to display analytical data effectively</p> -->
            </div>
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item">Commissions</li>
                <li class="breadcrumb-item active"><a href="#">Manage Commission</a></li>
            </ul>
        </div>
        <div class="">
            <a class="btn btn-primary" href="{{route('tax.create')}}"><i class="fa fa-plus"> Add Commission</i></a>
        </div>
